...
public class battleship {
    ...
    public static void main( String[] args ) throws JSONException {
        ...
        JSONArray boards = retrieveBoards("https://student.people.co/api/challenge/battleship/2e8bc9ac7d1d/boards");
        JSONObject board = retrieveBoard(boards.getJSONObject(0), "https://student.people.co/api/challenge/battleship/2e8bc9ac7d1d/boards/");
        ...
        for (String topAxi : topAxis) {
            for (String leftAxi : leftAxis) {
            	if(skip == 0)
            		lastMove = makeMove(boards.getJSONObject(1), topAxi + leftAxi, "https://student.people.co/api/challenge/battleship/2e8bc9ac7d1d/boards");
            	else if (skip !=0) {
            		skip--;
            		break;
            	}
            	if(!lastMove.getBoolean("is_hit") && skip == 0) {
                	skip += 2;
                }
